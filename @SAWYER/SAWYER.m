...
L1 = Link('d',0.317,'a',0.081,'alpha',pi/2,'qlim',[(-100*(pi/180)),(0*(pi/180))], 'offset', 200 + (151 *(pi/180)));
L2 = Link('d',-0.1925,'a',0,'alpha',-pi/2,'qlim', [(0*(pi/180)),(25*(pi/180))], 'offset', 0 + (90 *(pi/180)));
L3 = Link('d',-0.4,'a',0,'alpha',-pi/2,'qlim', [(0*(pi/180)),(0*(pi/180))], 'offset', 110 + (180 *(pi/180)));
L4 = Link('d',-0.1685,'a',0,'alpha',pi/2,'qlim',[(0*(pi/180)),(95*(pi/180))],'offset', 110 + (0 *(pi/180))); 
L5 = Link('d',0.4,'a',0,'alpha',-pi/2,'qlim',[(0*(pi/180)),(5*(pi/180))], 'offset', 110 + (180 *(pi/180)));
L6 = Link('d',0.1363,'a',0,'alpha',pi/2,'qlim',[(-125*(pi/180)),(0*(pi/180))], 'offset', 110 + (180 *(pi/180)));
L7 = Link('d',0.23505,'a',0,'alpha',0,'qlim',[(-360*(pi/180)),(260*(pi/180))], 'offset', 110 + (0 *(pi/180)));
